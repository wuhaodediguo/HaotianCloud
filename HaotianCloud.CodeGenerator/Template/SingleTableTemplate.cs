...
namespace HaotianCloud.CodeGenerator
{
    public class SingleTableTemplate
    {
        private string buttoncacheKey = "HaotianCloud_modulebuttondata_";
        private string fieldscacheKey = "HaotianCloud_modulefieldsdata_";
        ...
        public BaseConfigModel GetBaseConfig(string path, string username, string tableName, string tableDescription, List<ColumnField> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = Path.Combine(path, "HaotianCloud.Domain\\Entity");
            baseConfigModel.OutputConfig.OutputService = Path.Combine(path, "HaotianCloud.Service");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "HaotianCloud.Web");
            #endregion
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt, string idColumn = "F_Id")
        {
            ...
            //sb.AppendLine("using HaotianCloud.Code;");
            sb.AppendLine("using System.ComponentModel.DataAnnotations;");
            sb.AppendLine("using Chloe.Annotations;");
            sb.AppendLine();

            sb.AppendLine("namespace HaotianCloud.Domain." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt, string idColumn = "F_Id", string idType = "int", string deleteMarkField = "IsDelete", string createTimeField = "AddTime")
        {
            ...
            sb.AppendLine("using HaotianCloud.Domain." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace HaotianCloud.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
            ...
            {
                sb.AppendLine("        private string cacheKey = \"HaotianCloud_" + baseConfigModel.FileConfig.ClassPrefix.ToLower() + "data_\";");
            }
        ...
        public string BuildController(BaseConfigModel baseConfigModel, string idColumn = "F_Id", string idType = "string")
        {
            ...
            sb.AppendLine("using HaotianCloud.Code;");
            sb.AppendLine("using HaotianCloud.Domain." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using HaotianCloud.Service;");
            sb.AppendLine("using Microsoft.AspNetCore.Authorization;");
            sb.AppendLine("using HaotianCloud.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace HaotianCloud.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
