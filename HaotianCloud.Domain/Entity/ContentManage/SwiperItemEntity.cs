...
namespace HaotianCloud.Domain.ContentManage
{
    /// <summary>
    /// 创 建：超级管理员
    ...
    /// 描 述：首页轮播图广告实体类
    /// </summary>
    [TableAttribute("cms_swiperitem")]
    public class SwiperItemEntity : IEntity<SwiperItemEntity>,ICreationAudited,IModificationAudited,IDeleteAudited
    {
        /// <summary>
        /// 文章主键Id
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        [Required(ErrorMessage = "广告类别不能为空")]
        ...
        /// </summary>
        /// <returns></returns>
        [Required(ErrorMessage = "广告标题不能为空")]
