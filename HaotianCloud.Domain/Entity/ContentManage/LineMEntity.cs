...
namespace HaotianCloud.Domain.ContentManage
{
    ...
    /// 描 述：商品实体类
    /// </summary>
    [TableAttribute("cms_Goods")]
    public class LineMEntity : IEntity<LineMEntity>,ICreationAudited,IModificationAudited,IDeleteAudited
    {
        /// <summary>
        /// 文章主键Id
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        [Required(ErrorMessage = "线路类别不能为空")]
