...
namespace HaotianCloud.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                config.SwaggerDoc("v1", new OpenApiInfo { Title = "HaotianCloud Api", Version = "v1" });
        ...
        {
            var assemblys = Assembly.Load("HaotianCloud.Service");//Service是继承接口的实现方法类库名称
