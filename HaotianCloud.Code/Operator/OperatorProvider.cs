...
namespace HaotianCloud.Code
{
    public class OperatorProvider
    {
        ...
        //HaotianCloud_operator_pc_ PC端登录
        //HaotianCloud_operator_info_ 登录次数
        //
        /// <summary>
        /// 缓存操作类
        /// </summary>
        private string cacheKeyOperator = "HaotianCloud_operator_";// +登录者token
        private string cacheKeyToken = "HaotianCloud_token_";// +登录者token
        private string cacheKeyError = "HaotianCloud_error_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "HaotianCloud_Token";
        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "HaotianCloud_Mark";
