...
namespace HaotianCloud.Service.ContentManage
{
    ...
    {
        public GoodsService(IDbContext context) : base(context)
        {

        }
        private string cacheKey = "HaotianCloud_cms_Goodsdata_";
        ...
        public async Task<List<GoodsEntity>> GetLookList(SoulPage<GoodsEntity> pagination, string keyword = "", string CategoryId="")
        {
            //反格式化显示只能用"等于"，其他不支持
            ...
            //权限过滤
            query = GetDataPrivilege<GoodsEntity>("u", "",query);           
