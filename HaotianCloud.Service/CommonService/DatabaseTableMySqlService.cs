...
using HaotianCloud.DataBase.Extensions;
...
namespace HaotianCloud.Service.CommonService
{
    public class DatabaseTableMySqlService : RepositoryBase, IDatabaseTableService
    {
        ...
        /// <summary>
        /// 仅用在HaotianCloud框架里面，同步不同数据库之间的数据，以 MySql 为主库，同步 MySql 的数据到SqlServer和Oracle，保证各个数据库的数据是一样的
        /// </summary>
        /// <returns></returns>
        ...
        {
            string sqlServerConnectionString = "192.168.1.17;Initial Catalog = HaotianCloudNetDb;User ID=sa;Password=admin@12345;MultipleActiveResultSets=true";
