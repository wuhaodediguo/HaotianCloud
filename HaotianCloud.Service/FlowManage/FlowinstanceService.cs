...
using HaotianCloud.Service.CommonService;
using HaotianCloud.Domain.SystemOrganize;
using System.Net.Http;
using System.IO;
using System.Reflection;
using HaotianCloud.Domain.InfoManage;
using HaotianCloud.Service.InfoManage;
...
namespace HaotianCloud.Service.FlowManage
{
	...
	public class FlowinstanceService : DataFilterService<FlowinstanceEntity>, IDenpendency
    {
        ...
        private string cacheKey = "HaotianCloud_flowinstancedata_";
        ...
        public async Task CreateInstance(FlowinstanceEntity entity)
        {
            ...
            if (entity.F_FrmType == 1)
            {
                ...
                var t = referencedAssemblies
                    .SelectMany(a => a.GetTypes().Where(t => t.FullName.Contains("HaotianCloud.Service.") && t.FullName.Contains("." + entity.F_DbName + "Service"))).FirstOrDefault();
